...
<body>
	...
	<div class="dashboard-main-wrapper">
									...
									<table class="table">
										<thead class="bg-light">
											<tr class="border-0">
												...
												<th class="border-0">Nom Commune</th>
		...
		<!-- jvactormap js-->
		<script
			src="./assets/vendor/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
		<script
			src="./assets/vendor/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
		<!-- sparkline js-->
